                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">{prepData.companyOverview.industry}</p>
                    </div>
                    <div>
                  ...
                  <div className="space-y-4">
                    {prepData.jobSpecificPrep.behavioralQuestions.map((item, index) => (
                      <Card key={index}>
                        ...
                        <CardContent className="space-y-4">
                          <div>
                            <h4 className="font-medium text-gray-900 mb-2">Suggested Answer</h4>
                            <p className="text-gray-700 leading-relaxed">{item.suggestedAnswer}</p>
                          </div>
                          <div>
