...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto p-6 space-y-4">
      ...
      <p className="text-sm text-foreground">You control your data. Manage consent, exports, and deletion here.</p>
      ...
      <p className="text-sm text-foreground">We share data only with processors necessary to provide the service (e.g., cloud hosting, AI provider, logging). We do not sell personal data. When you connect third‑party services (e.g., Google Calendar), your data is shared as required to perform those functions.</p>
      ...
      <p className="text-sm text-foreground">For privacy requests, contact support via the app or email listed in your account receipts.</p>
    </div>
  )
}
